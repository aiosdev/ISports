...
public class StepArcView extends View {
     ...
     * 目标步数
     */
    private String stepNumberTarget = "0";
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF rectF = new RectF(centerX - 150, borderWidth, centerX + 150, borderWidth + 300);
    ...
    private void drawTextStepString(Canvas canvas, float centerX) {
        ...
        String stepString = "目标: " + stepNumberTarget + "步";
