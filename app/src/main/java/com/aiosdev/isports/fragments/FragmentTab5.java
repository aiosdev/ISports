...
public class FragmentTab5 extends LazyFragment {
    ...
    private class MyAdapter extends IndicatorFragmentPagerAdapter {
        ...
        public Fragment getFragmentForPage(int position) {
            switch (position){
                case 0:
                    FragmentTab5One fragmentTab5One = new FragmentTab5One();
                    Bundle bundle = new Bundle();
                    bundle.putString(FragmentTab5One.INTENT_STRING_TABNAME, tabName);
                    bundle.putInt(FragmentTab5One.INTENT_INT_POSITION, position);
                    fragmentTab5One.setArguments(bundle);
                    return fragmentTab5One;
                case 1:
                    FragmentTab5Two fragmentTab5Two = new FragmentTab5Two();
                    Bundle bundle1 = new Bundle();
                    bundle1.putString(FragmentTab5Two.INTENT_STRING_TABNAME, tabName);
                    bundle1.putInt(FragmentTab5Two.INTENT_INT_POSITION, position);
                    fragmentTab5Two.setArguments(bundle1);
                    return fragmentTab5Two;
            }
