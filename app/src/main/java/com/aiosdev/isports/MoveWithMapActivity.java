...
public class MoveWithMapActivity extends AppCompatActivity implements LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener , OnMapReadyCallback, View.OnClickListener{
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0x12:
                    Toast.makeText(MoveWithMapActivity.this, "Service发送过来的结果是......"
                ...
                case 0x15:
                    ...
                    Picasso.with(MoveWithMapActivity.this).load(ivUrl).into(weatherImage);
    ...
    public void onClick(View view) {
        //初始化service
        Intent moveService = new Intent(MoveWithMapActivity.this, MoveService.class);
        switch (view.getId()) {
            ...
            case R.id.move_bt_stop:
                ...
                //判断等级和头衔的变化
                String[] strGrade = {"初级", "初级", "初级", "初级", "中级", "中级", "中级", "中级", "高级", "高级", "高级",
                        "高级", "运动专家", "运动专家", "运动专家", "运动专家", "资深运动专家", "资深运动专家"};
                String[] strTitle = {"列兵", "一等兵", "二等兵", "三等兵", "少尉", "中尉", "上尉", "大尉",
            ...
            case R.id.move_bt_map:
                ...
                intent.setClass(MoveWithMapActivity.this, MoveMapsActivity.class);
